...
<table style="width: 100%; border: none;">
  <tr style="border: none;">
    <td style="width: 40%; text-align: center; border: none;"> <img src="images/meet blocked firefox.png" style="height: 250px; object-fit: contain;"> </td>
   <td style="width: 10%; border: none;"> &nbsp;</td>
    <td style="width: 40%; text-align: center; border: none;"> <img src="images/search blocked chrome.png" style="height: 250px; object-fit: contain;"> </td>
  </tr>
</table>
